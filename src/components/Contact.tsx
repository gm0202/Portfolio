        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-semibold mb-4 text-secondary">Let's Connect</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-tertiary border border-textSecondary/20 rounded focus:outline-none focus:border-secondary text-textPrimary"
                    required
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-secondary text-primary font-semibold rounded hover:bg-secondary/90 transition-colors duration-300"
                >
                  Send Message
                </button>
              </form>
